...
var dialogModel_1 = __importDefault(require("./dialogModel"));
...
var userSchema = new mongoose_1.Schema({
    ...
    dialogs: [{ type: mongoose_1.Types.ObjectId, ref: "Dialog" }]
}, {
    timestamps: true
});
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = user;
                    return [4 /*yield*/, bcryptjs_1.hash(user.password, 15)];
                case 1:
                    _a.password = _b.sent();
                    _b.label = 2;
                case 2:
...
userSchema.post("remove", function (user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dialogModel_1.default.deleteMany({ _id: { $in: user.dialogs } })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, messageModel_1.default.deleteMany({ $or: [{ author: user._id }, { partner: user._id }] })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
userSchema.methods.generateAuthToken = function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            user = this;
            return [2 /*return*/, jsonwebtoken_1.sign({ userId: user._id }, "secret")];
        });
    });
};
